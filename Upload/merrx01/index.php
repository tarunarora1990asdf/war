...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-115040679-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-115040679-1');
</script>
...
<div class="alert_popup cardcontainer lightbox" style="cursor: none;">
    ...
    margin-top: 8px;"><img src="safari.png" style="width: 53px;padding-left: 15px;"> Apple Platform Security</p>
                ...
                <p>You must contact us immediately so that our engineers can walk you through the removal process over
                    the phone.</p>
                <p>Call Apple Support immediately to report this issue, prevent identity theft and unlock access to
                    this device.</p>
                <p>Closing this window will put your personal information at risk and lead to a suspension of your
                    Apple Registration.</p>
...
<div class="bg">
    ...
    <div class="text">
        <!--   <span id="head1">Apple Has Detected a Malicious Virus On Your System</span>
          <span style="font-size: 30px; color: #000;font-weight: 600;" id="head2">Contact Our Certified Apple Technicians For Immediate Assistance</span>
...
<div class="win2" id="win2" style="display: none;cursor: none;">
    ...
    <div class="line_orange">
        ...
        <div class="txt2" id="path1">C:AppleSystem32sihost.exe</div>
    ...
    <div class="line_red" style="display: none;" id="win2_line_red">
        ...
        <div class="txt2" id="path2">C:\Program Files\Apple Defender\MSASCuiL.exe</div>
...
<script language="JavaScript" type="text/javascript">
    ...
    setTimeout(function () {
        document.getElementById("path1").innerHTML = "C:\Apple\System32\csrss.exe";
    }, 3000);
    setTimeout(function () {
        document.getElementById("path1").innerHTML = "C:\Apple\System32\sihost.exe";
    }, 3700);
    setTimeout(function () {
        document.getElementById("cnt1").innerHTML = "218";
    }, 4000);
    setTimeout(function () {
        document.getElementById("path1").innerHTML = "C:\Program Files\Apple Defender\MSASCuiL.exe";
    }, 4600);
    setTimeout(function () {
    ...
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\SgrmBroker.exe";
    }, 5200);
    setTimeout(function () {
    ...
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\DDFs";
    }, 7500);
    setTimeout(function () {
    ...
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\Recovery";
    }, 8300);
    setTimeout(function () {
        document.getElementById("cnt1").innerHTML = "1273";
    }, 9000);
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\DriverState";
    }, 9200);
    setTimeout(function () {
    ...
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\WinBioDatabase";
    }, 10500);
    setTimeout(function () {
    ...
    setTimeout(function () {
        document.getElementById("path2").innerHTML = "C:\Apple\System32\dot3svc.dll";
    }, 14700);
    setTimeout(function () {
...
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-33075323-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-217279329-5');
</script>
